...
rootdir = os.path.join(DATASET_DIR, 'zuco2-task2-tsr', 'Matlab files') + os.sep

print('##############################')
print(f'start processing ZuCo task2-TSR-2.0...')
...
for file in tqdm(os.listdir(rootdir)):
    if file.endswith(task+".mat"):
        ...
        # Extract subject name from filename, e.g. "resultsYAC_TSR.mat" -> "YAC"
        subject = os.path.basename(file).replace('results', '').split('_')[0]
